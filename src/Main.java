...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n\nCalculateAveragePriceInCategory");
		System.out.println("Average of Category1 products: " + manager.calculateAveragePriceInCategory("Category 1"));
		System.out.println("Average of Category2 products: " + manager.calculateAveragePriceInCategory("Category 2"));
		System.out.println("Average of Category3 products: " + manager.calculateAveragePriceInCategory("Category 3"));
